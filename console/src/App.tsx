...
import RouteUsers from 'components/user/route_list'
...
import RouteTemplates from 'components/message_template/route_list'
                  ...
                  <Route element={<OrganizationsCtx />}>
                    ...
                    <Route element={<CurrentOrganizationCtx />}>
                      ...
                      <Route element={<CurrentWorkspaceCtx />}>
                        ...
                        />
                        <Route
                          path="/orgs/:organizationId/workspaces/:workspaceId/templates"
                          element={<RouteTemplates />}
                        />
                        <Route
