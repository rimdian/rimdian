var Rimdian = (function () {
  ...
  */
  ...
  // }
  return Rimdian.log("info","new authenticated user detected, reset context",a),Rimdian.currentDevice=void 0,Rimdian._localStorage.remove("device"),Rimdian._createDevice(),Rimdian.currentSession=void 0,Rimdian._deleteCookie("session"),Rimdian._handleSession(),Rimdian.currentUser=__assign({},a),void(void 0===Rimdian.currentUser.created_at&&(Rimdian.currentUser.created_at=new Date().toISOString()));// create a user_alias if previous user was anonymous
