...
type Repository interface {
	...
	ListSubscriptionListUsers(ctx context.Context, workspaceID string, userIDs []string) (subscriptions []*entity.SubscriptionListUser, err error)
	GetSubscriptionListUsersToMessage(ctx context.Context, workspaceID string, listIDs []string, offset int64, limit int64) (subscribers []*entity.SubscriptionListUser, err error)
