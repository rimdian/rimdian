...
func (mock *RepositoryMock) FindUserByID(ctx context.Context, workspace *entity.Workspace, userID string, tx *sql.Tx) (*entity.User, error) {
	...
	return mock.FindUserByIDFunc(ctx, workspace, userID, tx)
}
