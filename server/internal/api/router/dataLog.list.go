...
func (api *API) DataLogList(w http.ResponseWriter, r *http.Request) {

	ctx := r.Context()
	ochttp.SetRoute(ctx, "/api/dataLog.list")
	...
	result, code, err := api.Svc.DataLogList(ctx, claims.AccountID, params)
