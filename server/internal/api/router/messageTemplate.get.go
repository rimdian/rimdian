...
func (api *API) MessageTemplateGet(w http.ResponseWriter, r *http.Request) {

	ctx := r.Context()
	ochttp.SetRoute(ctx, "/api/messageTemplate.get")
	...
	result, code, err := api.Svc.MessageTemplateGet(ctx, claims.AccountID, params)
