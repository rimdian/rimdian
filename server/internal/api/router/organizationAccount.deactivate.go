...
// OrganizationAccountDeactivate
func (api *API) OrganizationAccountDeactivate(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	ochttp.SetRoute(ctx, "/api/organizationAccount.deactivate")
	...
	payload := &dto.OrganizationAccountDeactivate{}
	...
	code, err := api.Svc.OrganizationAccountDeactivate(ctx, claims.AccountID, payload)
