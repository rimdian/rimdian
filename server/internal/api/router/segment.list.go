...
func (api *API) SegmentList(w http.ResponseWriter, r *http.Request) {

	ctx := r.Context()
	ochttp.SetRoute(ctx, "/api/segment.list")
	...
	result, code, err := api.Svc.SegmentList(ctx, claims.AccountID, params)
